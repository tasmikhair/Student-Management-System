                                        ...
                                        <div class="table-responsive border rounded p-1">
                                            <table class="table">
                                                ...
                                                <tbody>
                                                    ...
                                                    $sql = "SELECT tblteacher.TeacherID,tblteacher.ID as sid,tblteacher.TeacherName,tblteacher.TeacherEmail,tblteacher.JoiningDate,tblteacher.TeacherSubject,tblteacher.Gender, tblsubject.SubjectName from tblteacher join tblsubject on tblsubject.ID=tblteacher.TeacherSubject LIMIT $offset, $no_of_records_per_page";
                                                    $query = $dbh->prepare($sql);
                                                    $query->execute();

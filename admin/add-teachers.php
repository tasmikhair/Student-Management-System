...
if (strlen($_SESSION['sturecmsaid'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $ret = "select UserName from tblteacher where UserName=:uname || TeacherID=:teacherID";
        ...
        if ($query->rowCount() == 0) {
            ...
            if (!in_array($extension, $allowed_extensions)) {
                ...
                $sql = "insert into tblteacher(TeacherName,TeacherEmail,TeacherSubject,Gender,DOB,TeacherID,ContactNumber,Address,UserName,Password,Image)values(:teacherName,:teacherEmail,:teacherSubject,:gender,:dob,:teacherID,:connum,:address,:uname,:password,:image)";
...
?>
    ...
    <head>
        ...
        <title>Student Management System|| Add Teachers</title>
        <!-- plugins:css -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="forms-sample" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="teacherID" value="" class="form-control" placeholder="Ex: T12345" required='true'>
                                            </div>
                                            <div class="form-group">
